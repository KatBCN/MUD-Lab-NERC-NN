...
def build_network(codes) :
   ...
   conv  = Conv1D(256, 2, padding='valid', activation='relu', strides=1)(drops)
   #conv2 = Conv2D(10,3,2,'valid',activation='relu')(conv)
   #conv3 = Conv2D(20,3,2,'valid',activation='relu')(conv2)
   flatten = Flatten()(conv)
   dense = Dense(200,activation='relu')(flatten)
   conv_pool = MaxPooling1D(pool_size=2)(dense)
